...
// Author: five-5
// This is just for cpp primer ex9.46 :
// accept strname and prefix and suffix use insert postion and lenth info to add to name
...
std::string add_pre_and_suf(
    ...
    const std::string &suffix) {
        ...
        str_temp.insert(str_temp.end(), suffix.begin(), suffix.end());
        return str_temp;
}
